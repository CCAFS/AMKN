  ...
  return declare([GraphicsLayer], {
    ...
    onClick: function(e) {
      ...
      if ( singles.length > this._maxSingles ) {
        ...
        e.stopPropagation();
        var cPx = new esri.geometry.Point(this._map.toMap(e.screenPoint).x, this._map.toMap(e.screenPoint).y, this._map.spatialReference);
        this._map.centerAndZoom(cPx, this._map.getZoom()+2);
