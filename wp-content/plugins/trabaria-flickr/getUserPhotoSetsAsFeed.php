...
?>
<rss version="2.0" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:geo="http://www.w3.org/2003/01/geo/wgs84_pos#" xmlns:georss="http://www.georss.org/georss" xmlns:woe="http://where.yahooapis.com/v1/schema.rng">
	<channel>
		<title><?php echo htmlspecialchars($userInfo[0]->realname) ; ?> Flickr Photo Sets</title>
		<link><?php echo $userInfo[0]->photosurl ; ?></link>
                <description><?php echo htmlspecialchars($userInfo[0]->realname) ; ?> Flickr Photo Sets</description>
...
$photoSetDescription = htmlspecialchars($photoSets[$i]->description);
	foreach($updatesInSet as $updateInSet)
	{
       ...
       ?>
		<item>
			<title><?php echo $photoSetTitle ; ?></title>
			<link>http://www.flickr.com/photos/<?php echo $user_id ; ?>/sets/<?php echo $setID ; ?>/</link>
			<description>
       <?php
	foreach($photosInSet as $photoInSet)
	{
            ...
            ?>
                            &lt;div id=&quot;photoSetThumb&quot;&gt;

                                &lt;a rel=&quot;lightbox[<?php echo $setID ; ?>]&quot; title=&quot;<?php echo $arrPhoto["title"] ; ?>&quot;  href=&quot;<?php echo $arrPhoto["url_m"] ; ?>&quot;&gt;
                                &lt;img src=&quot;<?php echo $arrPhoto["url_t"] ; ?>&quot; /&gt;
                                &lt;/a&gt;
                            &lt;/div&gt;
            <?php
        }
    ...
    <pubDate><?php echo $dateLastUpdated ; ?></pubDate>
    <guid isPermaLink="false">tag:flickr.com,2004:/<?php echo $user_id ; ?>/sets/<?php echo $setID ; ?></guid>
    <georss:point><?php echo $setGeoLat ; ?> <?php echo $setGeoLon ; ?></georss:point>
    <geo:lat><?php echo $setGeoLat ; ?></geo:lat>
    <geo:long><?php echo $setGeoLon ; ?></geo:long>
    <woe:woeid><?php echo $setWoeID ; ?></woe:woeid>
    <dc:galleryThumb><?php echo $primPhotoURL ; ?></dc:galleryThumb>
</item>
<?php
   }
?>
