...
$identifyResponse["baseURL"] = "http://oai2.amkn.org/oai2.php";
...
$repositoryIdentifier = 'http://amkn.org/oai2.php';
...
$SETS = array(
    ...
    array('setSpec' => 'amkn_blog_posts', 'setName' => 'Adaptation and mitigation knowledge network')
  );
