...
<div class="content">
  ...
  <div id="tabs1" style="width:100%">
    <ul>
      <li><a href="#tab-1">Model Parameters</a></li>
      <li><a href="#tab-2">About the tool</a></li>

    </ul>
    <div id="tab-1">
      <h3>Generator Parameters</h3>
      <form action="" method="post" name="input_form" id="input_form" class="pure-form  pure-form-stacked">
        ...
        <div class="pure-g">
          <div class="pure-u-1 pure-u-md-1-3">
            <label for="state"><b>Model<img src="<?php bloginfo('template_directory'); ?>/images/info.png" align="absmiddle" style="border:0;margin:0;" title="Select a General Circulation Model (GCM) from the six provided. Average is the mean for the ensemble of six GCMs for the scenario you choose."/></b></label>
          ...
          <div class="pure-u-1 pure-u-md-1-3">
            <label for="radio"><b>Scenario<img src="<?php bloginfo('template_directory'); ?>/images/info.png" align="absmiddle" style="border:0;margin:0;" title="Select one of the three AR4 SRES scenarios. A1b is the medium emissions scenario. A2 is the high emissions scenario. B1 is the low emissions scenario"/></b></label>
            <label for="option-one" class="pure-radio">
              <input id="option-one" type="radio" name="scenario" value="a1" checked>
              A1b
            </label>
            <label for="option-two" class="pure-radio">
              <input id="option-two" type="radio" name="scenario" value="a2">
              A2
            </label>
            <label for="option-three" class="pure-radio">
              <input id="option-three" type="radio" name="scenario" value="b1">
              B1
            </label>
          </div>
          <div class="pure-u-1 pure-u-md-1-3">
            <label for="yearsimulation"><b>Year of Simulation<img src="<?php bloginfo('template_directory'); ?>/images/info.png" align="absmiddle" style="border:0;margin:0;" title="Note that if the year is between 2000 and 2010, these are still generated data (of course), using the delta regressions as generated by the respective GCM downscaled using MarkSim climate typing from the baseline of 1961-1990. Just to be clear, generating daily data for any year means that the climatology used is for a time slice of multiple years centred on that year."/></b></label>
            ...
            <span class="modeldescript">
              ...
              <b> Base WorldClim<img src="<?php bloginfo('template_directory'); ?>/images/info.png" align="absmiddle" style="border:0;margin:0;" title="WorldClim Baseline (1960 - 1990). Use this to get the WorldClim regression model data."/></b></span>
          </div>
          <div class="pure-u-1 pure-u-md-1-3">
            <label for="numrep"><b>Number of Replications<img src="<?php bloginfo('template_directory'); ?>/images/info.png" align="absmiddle" style="border:0;margin:0;" title="Select a number of Replications."/></b></label>
            <select name="numrep" >
            </select>
          </div>
          <div class="pure-u-1 pure-u-md-1-3">
            <label for="seed"><b>Seed<img src="<?php bloginfo('template_directory'); ?>/images/info.png" align="absmiddle" style="border:0;margin:0;" title="Random number seed. Use this to set the same run of random numbers when you need to produce two or more comparable sets of data. If left as zero it will be chosen at random from the system clock."/></b></label>
            <input type="text" name="seed" size="17" value="1234" title="Random number seed" />
          </div>
        </div>
      ...
      <div style="display: none;" id="wcNoResults"  title="Results">
        Processing Job Failed. Please try again...
      </div>
      <div style="display: none;" id="wcResults"  title="Results">
        <table border="0" cellpadding="0" cellspacing="0" align="center" style="display: block; width: 100%;">
          ...
          <tr align="left" valign="top" id="td_results" style="display:none;" >
            <td style="width:700px;height:430px;">
              <div id="tabs" style="width:100%;height:410px;">
                <ul>
