...
<script src="<?php echo get_bloginfo('template_url'); ?>/ccafs-sites/climate-impacts/js/communication-assets.js"></script>
...
<h4>Availability of communication tools/assets</h4> 
