...
<script src="<?php echo get_bloginfo('template_url'); ?>/ccafs-sites/food-livelihood/js/food-sources.js"></script>
...
<h4>Household’s main source of food</h4>
