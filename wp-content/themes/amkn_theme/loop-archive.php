...
<a href="<?php the_permalink(); ?>"><img width="306" height="171"  src="<?php echo $postThumb; ?>" alt="Video Testimonials" /></a>
...
<a href="<?php the_permalink(); ?>"><img width="306" src="<?php echo $postThumb; ?>" alt="Video Testimonials" /></a>
<p><?php echo $metaDesc; ?></p>
</div>
</div>
<?php
...
<?php
    ...
    $staticMapURL = "http://maps.google.com/maps/api/staticmap?center=".$geoPoint."&zoom=4&size=306x171&markers=icon:http%3A%2F%2F".$sURL."%2Fwp-content%2Fthemes%2Famkn_theme%2Fimages%2F".$post->post_type."-mini.png|".$geoPoint."&maptype=roadmap&sensor=false";
...
<a href="<?php the_permalink(); ?>"><img width="306" height="171" src="<?php echo $staticMapURL; ?>" /></a>
<p><?php echo $tEx; ?></p>
</div>
</div>
<?php
